...
public sealed class SupermatterContainedEvent : EntityEventArgs
{
    ...
    /// </summary>
    public readonly SupermatterComponent Supermatter;
    ...
    public SupermatterContainedEvent(EntityUid entity, SupermatterComponent supermatter, EntGotInsertedIntoContainerMessage args)
    {
        Entity = entity;
